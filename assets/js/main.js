...
(function ($) {
	...
	$('.heroslider-area').slick({
		...
		dots: false,
		arrows: true,
		prevArrow: '<button class="in-sliderarrow-arrow in-sliderarrow-prev"><i class="fa-solid fa-chevron-left"></i></button>',
		nextArrow: '<button class="in-sliderarrow-arrow in-sliderarrow-next"><i class="fa-solid fa-chevron-right"></i></button>',
		fade: true,
		adaptiveHeight: true,
	});
